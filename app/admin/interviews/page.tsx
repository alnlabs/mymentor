...
export default function AdminInterviewsPage() {
  ...
  const handleDeleteTemplate = async (templateId: string) => {
    if (!confirm('Are you sure you want to delete this interview template? This action cannot be undone.')) {
      return;
    }
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Mock Interview Management</h1>
          <p className="text-gray-600 mt-2">Create and manage interview templates for users</p>
        </div>
        <Button
        ...
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {templates.length > 0 
                  ? Math.round(templates.reduce((sum, t) => sum + t.duration, 0) / templates.length)
                  : 0} min
              </p>
            </div>
          </div>
          ...
          <Card key={template.id} className="p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => window.open(`/interviews?preview=${template.id}`, '_blank')}
              >
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg font-semibold mb-4">Create Interview Template</h3>
            <p className="text-gray-600 mb-4">
              This feature is coming soon! You'll be able to create custom interview templates with questions, time limits, and scoring.
            </p>
      ...
      {editingTemplate && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg font-semibold mb-4">Edit Interview Template</h3>
            <p className="text-gray-600 mb-4">
              Template editing feature is coming soon! You'll be able to modify questions, time limits, and other settings.
            </p>
            <div className="flex space-x-3">
              <Button
