...
export default function ProblemsUploadPage() {
  ...
  const downloadTemplate = (format: "json" | "csv") => {
    ...
    a.href = `/templates/problems-template.${format}`;
    a.download = `problems-template.${format}`;
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-lg">
              Upload multiple coding problems at once using CSV, Excel, or JSON files.
            </p>
          ...
          <div className="hidden lg:block">
            <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-center">
                ...
                <div className="text-sm opacity-90">Problems Import</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <Card className="border-2 border-gray-100 shadow-sm">
        <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl border border-green-200">
          <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center">
            ...
            Download Problem Templates
          </h3>
          <p className="text-gray-700 mb-4">
            Get started with our pre-filled problem templates that include all required fields and examples.
          </p>
      ...
      {/* Upload Area */}
      <Card className="border-2 border-gray-100 shadow-sm">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-t-xl border-b border-blue-200">
          <h3 className="text-xl font-bold text-gray-900 mb-3 flex items-center">
            <FileSpreadsheet className="w-6 h-6 mr-3 text-blue-600" />
            Upload Coding Problems
          </h3>
          <p className="text-gray-700">
            Upload CSV, Excel, or JSON files with multiple coding problems for efficient content management.
          </p>
        ...
        <div className="p-6">
          <div className="border-2 border-dashed border-gray-300 rounded-xl p-12 hover:border-blue-400 transition-all duration-300 bg-gradient-to-br from-gray-50 to-white">
            <input
              key={fileInputKey}
              type="file"
            ...
            >
              <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center mb-6 group-hover:from-blue-200 group-hover:to-indigo-200 transition-all duration-300">
              ...
              <span className="text-gray-600 text-center max-w-md">
                {selectedFile
                  ...
                  : "Drag and drop your problems file here, or click to browse. Supports CSV, Excel, and JSON formats up to 10MB."}
              </span>
              {!selectedFile && (
          ...
          >
            {uploading ? (
              <Loading size="sm" text="Uploading Problems..." />
            ) : (
              <>
