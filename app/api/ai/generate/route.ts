      ...
      switch (type) {
          ...
          const mcqTemplates = [
            {
              ...
              options: ["Hello World", "Error", "Undefined", "None of the above"],
        ...
        case "interview":
          ...
          const interviewTemplates = [
            ...
            {
              title: `System Design ${language} ${topic} Interview Question ${i + 1}`,
            ...
            {
              title: `Technical Leadership ${language} ${topic} Interview Question ${i + 1}`,
          ...
          const selectedInterview = interviewTemplates[i % interviewTemplates.length];
