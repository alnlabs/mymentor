...
async function generateWithAI(
  ...
  try {
    ...
    // When mixTypes is enabled, we'll use a variety of topics and difficulties
    const effectiveTopic = mixTypes ? "Mixed" : topic;
    const effectiveDifficulty = mixTypes ? "Mixed" : difficulty;
    ...
    if (mixTypes && type === "exam") {
      ...
      for (let i = 0; i < mcqCount; i++) {
          ...
          mcqTemplates = [
            {
              ...
              explanation: `For ${language} applications with ${
                10 + i
              } servers, Least Connections provides better performance.`,
            },
        ...
        generatedContent.push({
          ...
          tags: [language, mixedTopic, mixedDifficulty, "mcq"],
      ...
      for (let i = 0; i < problemCount; i++) {
        ...
        const problemTemplates = [
          {
            title: `${language} ${mixedTopic} Problem ${i + 1}`,
            content: `Implement a function in ${language} to solve the following ${mixedTopic} problem:\n\n**Problem:**\nGiven an array of numbers, find the maximum sum of any contiguous subarray.\n\n**Requirements:**\n- Use ${language} syntax\n- Handle edge cases\n- Optimize for performance`,
            explanation: `This problem tests ${mixedTopic} concepts in ${language} programming.`,
          },
          {
            title: `${language} ${mixedTopic} Algorithm ${i + 1}`,
            content: `Write a ${language} function to implement the following ${mixedTopic} algorithm:\n\n**Algorithm:**\nSort an array using efficient sorting techniques.\n\n**Constraints:**\n- Time complexity: O(n log n)\n- Space complexity: O(1)\n- Use ${language} best practices`,
        ...
        switch (type) {
          case "mcq":
            ...
            if (topic === "System Design") {
              ...
              mcqTemplates = [
                ...
                {
                  title: `${language} ${topic} Dynamic Programming MCQ ${
                    i + 1
                  }`,
              ...
              mcqTemplates = [
                {
                  ...
                  options: [
                    `SELECT * FROM users WHERE created_at >= DATE_SUB(NOW(), INTERVAL ${
                      30 + i
                    } DAY)`,
                    `SELECT * FROM users WHERE created_at > NOW() - ${30 + i}`,
                    `SELECT * FROM users WHERE status = 'active' AND created_at >= DATE_SUB(NOW(), INTERVAL ${
                      30 + i
                    } DAY) ORDER BY created_at`,
                    `SELECT * FROM users WHERE created_at BETWEEN NOW() AND DATE_SUB(NOW(), INTERVAL ${
                      30 + i
                    } DAY)`,
                  ],
                  correctAnswer: `SELECT * FROM users WHERE status = 'active' AND created_at >= DATE_SUB(NOW(), INTERVAL ${
                    30 + i
                  } DAY) ORDER BY created_at`,
                  explanation: `This query filters active users, checks registration within last ${
                    30 + i
                  } days, and orders by creation date.`,
                },
                {
                  title: `${language} ${topic} Database Index MCQ ${i + 1}`,
                  content: `Which index strategy is best for a ${language} application's user table with ${
                    10000 + i * 1000
                  ...
                  explanation: `For ${
                    10000 + i * 1000
                  } records, composite index on frequently searched columns with separate index for less common searches optimizes performance.`,
                },
                {
                  title: `${language} ${topic} Transaction MCQ ${i + 1}`,
                  content: `What happens when a ${language} application tries to update ${
                    5 + i
                  } user records in a single transaction?\n\n**Scenario:**\n- Update user status to 'inactive'\n- Update last_login timestamp\n- Update profile_count field\n\n**Database:**\nMySQL with InnoDB engine`,
                  options: [
                  ...
                  correctAnswer:
                    "All updates succeed or all fail (ACID compliance)",
                  explanation: `InnoDB transactions ensure ACID properties - all ${
                    5 + i
                  } updates either commit together or rollback together.`,
                },
                {
                  ...
                  correctAnswer:
                    "Normalized design with separate tables for products, orders, customers, categories, reviews",
                  explanation: `For ${language} e-commerce with ${
                    1000 + i * 100
                  } products and ${
                    10000 + i * 1000
                  } orders, normalized design prevents data redundancy and maintains integrity.`,
                },
                {
                  title: `${language} ${topic} Performance MCQ ${i + 1}`,
                  content: `Which query optimization technique is most effective for a ${language} application with ${
                    100000 + i * 10000
                  ...
                  explanation: `For ${
                    100000 + i * 10000
                  } records, a composite index on (email, status, created_at) will dramatically improve query performance.`,
                },
              ];
              ...
              mcqTemplates = [
                {
                  ...
                  content: `Which frontend framework is best for building a ${language} application with ${
                    1000 + i * 100
                  } components?`,
                  options: [
                  ...
                  explanation: `For ${language} applications with ${
                    1000 + i * 100
                  } components, React provides excellent component reusability.`,
                },
                {
                  title: `${language} ${topic} API Integration MCQ ${i + 1}`,
                  content: `How should you handle API calls in a ${language} web application with ${
                    10 + i
                  } endpoints?`,
                  options: [
                  ...
                  correctAnswer:
                    "Implement a centralized API service with error handling",
                  explanation: `For ${language} web apps with ${
                    10 + i
                  } endpoints, a centralized API service provides better error handling.`,
                },
                {
                  title: `${language} ${topic} State Management MCQ ${i + 1}`,
                  content: `Which state management solution is best for a ${language} application with ${
                    50 + i * 10
                  } components?`,
                  options: [
                  ...
                  explanation: `For ${language} apps with ${
                    50 + i * 10
                  } components, Redux provides predictable state management.`,
                },
                {
                  title: `${language} ${topic} Performance MCQ ${i + 1}`,
                  content: `How should you optimize performance for a ${language} web application with ${
                    1000 + i * 100
                  } users?`,
                  options: [
                  ...
                  explanation: `For ${language} web apps with ${
                    1000 + i * 100
                  } users, code splitting and caching provide optimal performance.`,
                },
                {
                  title: `${language} ${topic} Testing MCQ ${i + 1}`,
                  content: `Which testing strategy is best for a ${language} web application with ${
                    100 + i * 10
                  } components?`,
                  options: [
                    "Manual testing only",
                  ...
                  explanation: `For ${language} web apps with ${
                    100 + i * 10
                  } components, comprehensive testing ensures reliability.`,
                },
              ];
              ...
              mcqTemplates = [
                ...
                {
                  title: `${language} ${topic} State Management MCQ ${i + 1}`,
                  content: `How should you manage state in a ${language} mobile application with ${
                    20 + i * 5
                  } screens?`,
                  options: [
                    "Local state only",
                  ...
                  explanation: `For ${language} mobile apps with ${
                    20 + i * 5
                  } screens, Redux with AsyncStorage provides robust state management.`,
                },
                {
                  title: `${language} ${topic} Performance MCQ ${i + 1}`,
                ...
                },
                {
                  ...
                  content: `Which navigation solution is best for a ${language} mobile application with ${
                    10 + i * 2
                  } screens?`,
                  options: [
                    "Manual navigation",
                  ...
                  explanation: `For ${language} mobile apps with ${
                    10 + i * 2
                  } screens, React Navigation provides comprehensive navigation.`,
                },
                {
                  title: `${language} ${topic} Testing MCQ ${i + 1}`,
                  content: `Which testing approach is best for a ${language} mobile application with ${
                    50 + i * 5
                  } components?`,
                  options: [
                    "Manual testing only",
                  ...
                  explanation: `For ${language} mobile apps with ${
                    50 + i * 5
                  } components, comprehensive testing ensures quality.`,
                },
              ];
              ...
              mcqTemplates = [
                {
                  ...
                  content: `Which machine learning algorithm is best for a ${language} application with ${
                    1000 + i * 100
                  } data points?`,
                  options: [
                  ...
                  explanation: `For ${language} applications with ${
                    1000 + i * 100
                  } data points, Random Forest provides good performance.`,
                },
                {
                  title: `${language} ${topic} Data Preprocessing MCQ ${i + 1}`,
                  content: `How should you preprocess data for a ${language} machine learning model with ${
                    10000 + i * 1000
                  } samples?`,
                  options: [
                  ...
                  correctAnswer:
                    "Handle missing values + encode categorical + scale features",
                  explanation: `For ${language} ML models with ${
                    10000 + i * 1000
                  } samples, comprehensive preprocessing ensures better performance.`,
                },
                {
                ...
                {
                  title: `${language} ${topic} Feature Engineering MCQ ${
                    i + 1
                  }`,
                  content: `How should you engineer features for a ${language} machine learning model with ${
                    50 + i * 5
                  } features?`,
                  options: [
                  ...
                  explanation: `For ${language} ML models with ${
                    50 + i * 5
                  } features, comprehensive feature engineering improves performance.`,
                },
                {
                  title: `${language} ${topic} Deployment MCQ ${i + 1}`,
                  content: `How should you deploy a ${language} machine learning model with ${
                    100 + i * 10
                  } requests per second?`,
                  options: [
                  ...
                  explanation: `For ${language} ML models with ${
                    100 + i * 10
                  } requests/sec, API deployment with monitoring ensures reliability.`,
                },
              ];
              ...
              mcqTemplates = [
                {
                  ...
                  content: `How should you structure a CI/CD pipeline for a ${language} application with ${
                    5 + i
                  ...
                  explanation: `For ${language} applications with ${
                    5 + i
                  } microservices, separate pipelines with shared stages provide flexibility and faster deployments.`,
                },
                {
                  title: `${language} ${topic} Container Orchestration MCQ ${
                    i + 1
                  }`,
                  content: `Which container orchestration tool is best for managing ${
                    10 + i
                  } ${language} microservices in production?\n\n**Requirements:**\n- Auto-scaling based on load\n- Service discovery\n- Load balancing\n- Rolling updates`,
                  options: [
                  ...
                  explanation: `For ${
                    10 + i
                  } ${language} microservices in production, Kubernetes provides comprehensive orchestration with auto-scaling, service discovery, and rolling updates.`,
                },
                {
                  title: `${language} ${topic} Infrastructure as Code MCQ ${
                    i + 1
                  }`,
                  content: `How should you manage infrastructure for a ${language} application across ${
                    3 + i
                  ...
                  correctAnswer:
                    "Terraform with environment-specific variables",
                  explanation: `Terraform with environment-specific variables ensures consistent infrastructure across ${
                    3 + i
                  } environments for ${language} applications.`,
                },
                {
                  title: `${language} ${topic} Monitoring MCQ ${i + 1}`,
                  content: `Which monitoring strategy is best for a ${language} application serving ${
                    1000 + i * 100
                  ...
                  correctAnswer:
                    "Application Performance Monitoring (APM) + Infrastructure monitoring",
                  explanation: `For ${language} applications serving ${
                    1000 + i * 100
                  } users, APM + infrastructure monitoring provides comprehensive visibility into performance and issues.`,
                },
                {
                ...
                switch (lang.toLowerCase()) {
                  ...
                  case "java":
                    return {
                      ...
                      listComp:
                        "Arrays.stream(numbers).map(x -> x * 2).toArray()",
                  ...
                  case "c++":
                    return {
                      ...
                      array: "int numbers[] = {1, 2, 3, 4, 5};",
                      listComp:
                        "transform(numbers, numbers + 5, numbers, [](int x) { return x * 2; })",
          ...
          case "problem":
            ...
            const problemTemplates = [
              ...
              {
                title: `${language} ${topic} Valid Parentheses Problem ${
                  i + 1
                }`,
              ...
              {
                title: `${language} ${topic} Fibonacci Sequence Problem ${
                  i + 1
                }`,
          ...
          case "interview":
            ...
            const interviewTemplates = [
              {
                title: `Senior ${language} ${topic} Interview Question ${
                  i + 1
                }`,
