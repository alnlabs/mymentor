...
async function generateWithAI(
        ...
        questions: [
          {
            ...
            explanation: "`let` and `const` are block-scoped (ES6), meaning they are only accessible within the block they are declared. `var` is function-scoped and can be accessed throughout the entire function."
          },
          {
            ...
            explanation: "Due to hoisting, `var x` is declared at the top but not initialized. So `console.log(x)` prints `undefined`."
          }
        ],
        problems: [
          {
            title: "Array Manipulation",
            content: "Write a function that removes duplicates from an array without using Set or filter methods.\n\n**Requirements:**\n- Function should return a new array\n- Preserve the order of elements\n- Handle edge cases (empty array, null, undefined)",
            explanation: "This tests understanding of array methods, loops, and object properties for tracking unique values."
          }
        ]
      },
      advanced: {
        questions: [
          {
            ...
            correctAnswer: "1, 2",
            explanation: "This demonstrates closure - the inner function maintains access to the `count` variable from its outer scope."
          },
          {
            title: "JavaScript Promises",
            content: "What is the correct way to handle multiple promises that should execute in parallel?",
            options: [
              "Use Promise.all()",
              "Use Promise.race()",
            ...
            explanation: "Promise.all() waits for all promises to resolve and returns an array of results. If any promise rejects, the entire Promise.all() rejects."
          }
        ],
        problems: [
          {
            title: "Promise Implementation",
            content: "Implement a custom Promise class with basic functionality (resolve, reject, then, catch).\n\n**Requirements:**\n- Support for .then() and .catch() methods\n- Handle both synchronous and asynchronous operations\n- Support for promise chaining",
            explanation: "This tests deep understanding of how promises work internally and asynchronous programming concepts."
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            content: "What is the output of the following list comprehension?\n\n```python\nnumbers = [1, 2, 3, 4, 5]\nresult = [x * 2 for x in numbers if x % 2 == 0]\nprint(result)\n```",
            options: ["[2, 4, 6, 8, 10]", "[2, 4]", "[4, 8]", "[1, 3, 5]"],
            correctAnswer: "[4, 8]",
            explanation: "The comprehension multiplies even numbers by 2. Only 2 and 4 are even, so result is [4, 8]."
          },
          {
            title: "Python Dictionary Methods",
            content: "What is the difference between `.get()` and `[]` when accessing dictionary keys?",
            options: [
            ...
            correctAnswer: ".get() returns None for missing keys, [] raises KeyError",
            explanation: ".get() safely returns None (or a default value) for missing keys, while [] raises a KeyError exception."
          }
        ],
        problems: [
          {
            title: "File Processing",
            content: "Write a function that reads a CSV file and returns the data as a list of dictionaries.\n\n**Requirements:**\n- Handle missing or malformed data gracefully\n- Support custom delimiters\n- Return structured data with column names as keys",
            explanation: "This tests file I/O operations, data parsing, error handling, and data structure manipulation."
          }
        ]
      },
      advanced: {
        questions: [
          {
            ...
            explanation: "The decorator wraps the function and converts its return value to uppercase."
          }
        ],
        problems: [
          {
            title: "Context Manager",
            content: "Create a custom context manager class that measures execution time.\n\n**Requirements:**\n- Use __enter__ and __exit__ methods\n- Print execution time when exiting\n- Handle exceptions gracefully",
            explanation: "This tests understanding of context managers, class methods, and timing operations."
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            explanation: "Strings in Java are immutable. When you 'modify' a string, a new String object is created with the changes."
          },
          {
            title: "Java Access Modifiers",
            content: "Which access modifier allows access from any class in the same package?",
            options: ["private", "public", "protected", "default (no modifier)"],
            correctAnswer: "default (no modifier)",
            explanation: "The default access modifier (no keyword) allows access from any class in the same package."
          }
        ],
        problems: [
          {
            title: "LinkedList Implementation",
            content: "Implement a simple LinkedList class with add, remove, and find methods.\n\n**Requirements:**\n- Use a Node inner class\n- Support for adding at beginning and end\n- Handle edge cases (empty list, single element)",
            explanation: "This tests understanding of data structures, object-oriented programming, and linked list concepts."
          }
        ]
      }
    }
  ...
  for (let i = 0; i < count; i++) {
    ...
    const langContent = contentTemplates[language.toLowerCase() as keyof typeof contentTemplates] || contentTemplates.javascript;
    const difficultyContent = langContent[difficulty as keyof typeof langContent] || langContent.basics;
    
    switch (type) {
      case "mcq":
        const mcqTemplate = difficultyContent.questions?.[i % difficultyContent.questions.length] || {
      ...
      case "problem":
        const problemTemplate = difficultyContent.problems?.[i % difficultyContent.problems.length] || {
          ...
          explanation: "This is an advanced coding problem with detailed requirements."
        };
      ...
      case "exam":
        generatedContent.push({
          ...
          category: topic,
          language,
          explanation: "This exam question tests comprehensive understanding of the concept, including theory and practical application.",
      ...
      case "interview":
        generatedContent.push({
          ...
          category: topic,
          language,
          explanation: "This interview question assesses system design skills, technical depth, and problem-solving approach.",
