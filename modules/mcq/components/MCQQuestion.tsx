...
export const MCQQuestionComponent: React.FC<MCQQuestionProps> = ({
  question,
  onSubmit,
  isSubmitted = false,
  selectedAnswer,
}) => {
  const [currentAnswer, setCurrentAnswer] = useState<number | null>(selectedAnswer || null);
          ...
          {options.map((option: string, index: number) => (
            <label
              ...
              className={`flex items-center p-3 border rounded-lg cursor-pointer transition-colors ${
                ...
                isSubmitted && currentAnswer === index && index !== question.correctAnswer
