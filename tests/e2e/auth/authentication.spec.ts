...
test.describe("Authentication System", () => {
  ...
  test.describe("Login Page", () => {
    ...
    test("should handle invalid credentials gracefully", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Invalid credentials, text=Login failed")
      ).toBeVisible();
    });
  ...
  test.describe("Super Admin Login", () => {
    test("should display super admin login option", async ({ page }) => {
      ...
      const superAdminLink = page.locator(
        'text=Super Admin Login, a:has-text("Super Admin")'
      );
  ...
  test.describe("Route Protection", () => {
    ...
    test("should restrict admin routes to admin users", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Access denied, text=Unauthorized, text=Forbidden")
      ).toBeVisible();
    });
  });
  ...
  test.describe("Error Handling", () => {
    ...
    test("should handle server errors gracefully", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Server error, text=Something went wrong")
      ).toBeVisible();
    });
  });
