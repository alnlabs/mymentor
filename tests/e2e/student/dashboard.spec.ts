...
test.describe("Student Dashboard", () => {
  ...
  test.describe("Dashboard Layout", () => {
    ...
    test("should display user statistics correctly", async ({ page }) => {
      ...
      const statsElements = page.locator(
        '[data-testid="stat-card"], .stat-card, .statistics-card'
      );
  ...
  test.describe("Data Loading", () => {
    ...
    test("should show loading state while fetching data", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="loading"], .loading, text=Loading')
      ).toBeVisible();
    ...
    test("should handle empty data gracefully", async ({ page }) => {
      ...
      await assertionHelper.assertElementVisible("text=Dashboard");
      await expect(
        page.locator("text=No activity yet, text=No data available")
      ).toBeVisible();
    });
  });
  ...
  test.describe("Error Handling", () => {
    ...
    test("should handle API errors gracefully", async ({ page }) => {
      ...
      await expect(
        page.locator("text=Error loading data, text=Something went wrong")
      ).toBeVisible();
    });
    ...
    test("should display error boundary when component fails", async ({
      page,
    }) => {
  ...
  test.describe("Responsive Design", () => {
    ...
    test("should work on mobile devices", async ({ page }) => {
      ...
      const navButton = page.locator(
        '[data-testid="mobile-menu"], .mobile-menu, button:has-text("Menu")'
      );
